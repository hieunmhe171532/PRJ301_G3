...
<html class="no-js" lang="en">
    ...
    <head>
        ...
        <!-- For favicon png -->
		<link rel="shortcut icon" type="image/icon" href="../Css/HomePage/logo/favicon.png"/>
       
        <!--font-awesome.min.css-->
        <link rel="stylesheet" href="../Css/HomePage/css/font-awesome.min.css">

        <!--linear icon css-->
		<link rel="stylesheet" href="../Css/HomePage/css/linearicons.css">

		<!--animate.css-->
        <link rel="stylesheet" href="../Css/HomePage/css/animate.css">

		<!--flaticon.css-->
        <link rel="stylesheet" href="../Css/HomePage/css/flaticon.css">

		<!--slick.css-->
        <link rel="stylesheet" href="../Css/HomePage/css/slick.css">
		<link rel="stylesheet" href="../Css/HomePage/css/slick-theme.css">
		
        <!--bootstrap.min.css-->
        <link rel="stylesheet" href="../Css/HomePage/css/bootstrap.min.css">
		
		<!-- bootsnav -->
		<link rel="stylesheet" href="../Css/HomePage/css/bootsnav.css" >	
        
        <!--style.css-->
        <link rel="stylesheet" href="../Css/HomePage/css/style.css">
        
        <!--responsive.css-->
        <link rel="stylesheet" href="../Css/HomePage/css/responsive.css">
	...
	<body>
				...
				<div class="explore-content">
					<div class="row">
						<div class=" col-md-4 col-sm-6">
							<div class="single-explore-item">
								<div class="single-explore-img">
									<img src="../Css/HomePage/images/explore/e1.jpg" alt="explore image">
										...
										<div class="row">
											<div class="col-sm-2">
												<div class="explore-person-img">
													<a href="#">
														<img src="../Css/HomePage/images/explore/person.png" alt="explore person">
													</a>
												</div>
											</div>
											<div class="col-sm-10">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-explore-item">
								<div class="single-explore-img">
									<img src="../Css/HomePage/images/explore/e2.jpg" alt="explore image">
									<div class="single-explore-img-info">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-explore-item">
								<div class="single-explore-img">
									<img src="../Css/HomePage/images/explore/e3.jpg" alt="explore image">
									<div class="single-explore-img-info">
										<button onclick="window.location.href='#'">best rated</button>
										<div class="single-explore-image-icon-box">
											<ul>
						...
						<div class=" col-md-4 col-sm-6">
							<div class="single-explore-item">
								<div class="single-explore-img">
									<img src="../Css/HomePage/images/explore/e4.jpg" alt="explore image">
									<div class="single-explore-img-info">
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-explore-item">
								<div class="single-explore-img">
									<img src="../Css/HomePage/images/explore/e5.jpg" alt="explore image">
									<div class="single-explore-img-info">
										<button onclick="window.location.href='#'">featured</button>
										<div class="single-explore-image-icon-box">
											<ul>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-explore-item">
								<div class="single-explore-img">
									<img src="../Css/HomePage/images/explore/e6.jpg" alt="explore image">
									<div class="single-explore-img-info">
										<button onclick="window.location.href='#'">best rated</button>
										<div class="single-explore-image-icon-box">
											<ul>
				...
				<div class="testimonial-carousel">
						...
						<div class="testimonial-description">
							<div class="testimonial-info">
								<div class="testimonial-img">
									<img src="../Css/HomePage/images/clients/c1.png" alt="clients">
								</div><!--/.testimonial-img-->
				    ...
				    <div class="single-testimonial-box">
						<div class="testimonial-description">
							<div class="testimonial-info">
								<div class="testimonial-img">
									<img src="../Css/HomePage/images/clients/c2.png" alt="clients">
								</div><!--/.testimonial-img-->
								<div class="testimonial-person">
									<h2>monirul islam</h2>
									<h4>london, UK</h4>
				    ...
				    <div class="single-testimonial-box">
						<div class="testimonial-description">
							<div class="testimonial-info">
								<div class="testimonial-img">
									<img src="../Css/HomePage/images/clients/c3.png" alt="clients">
								</div><!--/.testimonial-img-->
								<div class="testimonial-person">
				    ...
				    <div class="single-testimonial-box">
						<div class="testimonial-description">
							<div class="testimonial-info">
								<div class="testimonial-img">
									<img src="../Css/HomePage/images/clients/c4.png" alt="clients">
								</div><!--/.testimonial-img-->
								<div class="testimonial-person">
									<h2>Tom Leakar</h2>
									<h4>london, UK</h4>
				...
				<div class="blog-content">
					<div class="row">
						<div class="col-md-4 col-sm-6">
							<div class="single-blog-item">
								<div class="single-blog-item-img">
									<img src="../Css/HomePage/images/blog/b1.jpg" alt="blog image">
								</div>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-blog-item">
								<div class="single-blog-item-img">
									<img src="../Css/HomePage/images/blog/b2.jpg" alt="blog image">
								</div>
								<div class="single-blog-item-txt">
									<h2><a href="#">How to find your Desired Place more quickly</a></h2>
									<h4>posted <span>by</span> <a href="#">admin</a> march 2018</h4>
						...
						<div class="col-md-4 col-sm-6">
							<div class="single-blog-item">
								<div class="single-blog-item-img">
									<img src="../Css/HomePage/images/blog/b3.jpg" alt="blog image">
								</div>
								<div class="single-blog-item-txt">
									<h2><a href="#">How to find your Desired Place more quickly</a></h2>
									<h4>posted <span>by</span> <a href="#">admin</a> march 2018</h4>
		...
		<script src="../Css/HomePage/js/jquery.js"></script>
        
        <!--modernizr.min.js-->
        <script src="https://cdnjs.cloudflare.com/ajax/libs/modernizr/2.8.3/modernizr.min.js"></script>
		
		<!--bootstrap.min.js-->
        <script src="../Css/HomePage/js/bootstrap.min.js"></script>
		
		<!-- bootsnav js -->
		<script src="../Css/HomePage/js/bootsnav.js"></script>

        <!--feather.min.js-->
        <script  src="../Css/HomePage/js/feather.min.js"></script>

        <!-- counter js -->
		<script src="../Css/HomePage/js/jquery.counterup.min.js"></script>
		<script src="../Css/HomePage/js/waypoints.min.js"></script>

        <!--slick.min.js-->
        <script src="../Css/HomePage/js/slick.min.js"></script>

		<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery-easing/1.4.1/jquery.easing.min.js"></script>
		     
        <!--Custom JS-->
        <script src="../Css/HomePage/js/custom.js"></script>
